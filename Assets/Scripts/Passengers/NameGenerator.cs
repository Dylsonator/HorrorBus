...
public sealed class NameGenerator : MonoBehaviour
{
    ...
    [SerializeField, Range(0f, 1f)] private float anomalyCopyHumanNameChance = 0f;
    ...
    {
        // Full visible-ID copying now happens in PassengerSpawner.
        // Keep this at 0 by default so anomalies do not only copy a name
        // while keeping a totally different DOB / ID number / expiry.
